...
export default function Page() { return <PolicyPage title="Terms of Use" summary="The conditions that should govern use of the HACEY Global website and its informational content." sections={sections} />; }
